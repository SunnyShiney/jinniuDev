<template>
  <el-container class="container">
    ...
    <Header @back="goback">
      ...
      <!-- 子系统名字 -->
      <template #content>
        <span class="content" style="font-size:25px">扬尘治理大数据协同管家</span>
      </template>
      <!-- 用户信息 -->
      <template #userinfo>
        <el-dropdown>
      ...
      <el-aside>
        <el-menu class="menu">
          ...
          <el-menu-item>
            ...
            <span style="font-size:20px"><a href="http://101.37.246.72/denglu_ycxt.exe" target="_blank">跳转主页脚本</a></span>
          </el-menu-item>
        </el-menu>
      </el-aside>
